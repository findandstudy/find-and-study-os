...
const expectedLocales = [
  "ar", "bn", "es", "fa", "fr", "hi", "id", "it", "kk", "ko", "ky", "ne", "pt", "ru",
  "tg", "tk", "tr", "uk", "ur", "uz", "vi", "zh",
];
...
try {
  ...
  assert.equal(queued.rowCount, 22);
  ...
  assert.equal(refreshed.rowCount, 22);
  ...
  console.log(
    "[program-translation-db] PASS: insert queues 22 locales; source edits invalidate leases; manual rows require review; cascade is clean",
  );
} catch (error) {
